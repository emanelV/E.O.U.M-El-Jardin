...
for($i = 0; $i < count($consu); $i++){
    ...
    $consu[$i]['acciones'] = '
    <button class="btn btn-primary" title="Editar" onclick="editarMateria('.$consu[$i]['materia_id'].')">Editar</button> 
    <button class="btn btn-danger" title="Eliminar" onclick="eliminarMateria('.$consu[$i]['materia_id'].')">Eliminar</button>
    ';
}
