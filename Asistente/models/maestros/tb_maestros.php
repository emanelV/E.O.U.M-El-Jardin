...
for($i = 0; $i < count($consu); $i++){
    ...
    $consu[$i]['acciones'] = '
    <button class="btn btn-primary" title="Editar" onclick="editarMaestro('.$consu[$i]['profesor_id'].')">Editar</button> 
    <button class="btn btn-danger" title="Eliminar" onclick="eliminarMaestro('.$consu[$i]['profesor_id'].')">Eliminar</button>
    ';
}
